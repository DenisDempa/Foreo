...
conn = psycopg2.connect(database="Foreo_db", user="postgres",password="denis",host="localhost",port="5432")
cur = conn.cursor()
...
execute(r'C:\Users\Sto. Diagnostika\Desktop\Deniss\FOREO\SpaceNK_2.0.xlsx', 'Last Week Report by Store')
